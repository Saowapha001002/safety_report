...
use App\Http\Controllers\Back\CheckMagicFinger;
...
// });
    Route::group(['middleware' => ['auth']], function () {
       ...
       // อนุมัติผ่านลิงก์ (ไม่ควบคุมสิทธิ์, แต่อิงจาก token)
        ...
        Route::get('/sheapprove/login', [ApproveLoginController::class, 'sheLoginWithToken'])->name('sheapprove.magic.login');
        Route::get('/manager/login', [ApproveLoginController::class, 'managerLoginWithToken'])->name('manager.magic.login');
