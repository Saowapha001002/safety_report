                        ...
                        <div class="card-body">
                            <div class="card shadow-none border p-2 h-90 mb-3">
                                <div class="mb-3" data-repeater-list="group-a">
                                    <span class="h4 text-primary mb-0 app-brand-text fw-semibold">ส่วนที่ 2 :  สำหรับผู้จัดการฝ่าย / ผู้ได้รับมอบหมาย</span>
                                    <div class="row">
                                        ...
                                        <div class="card-body p-3 pt-2">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                @if ($Tracking->she_status == 0)
                                                    <span class="badge rounded-pill bg-label-warning">ยังไม่แก้ไข
                                                    @else
                                                        <span class="badge rounded-pill bg-label-primary">SHE ดำเนินการแก้ไขเรียบร้อยแล้ว
                                                @endif
                                                </span>
                                                <p class="d-flex align-items-center justify-content-center gap-1 mb-0">
                                                    @if (!$Tracking->assign_solve_date)
                                            ...
                                            <div class="card-body p-3 pt-2">
                                                <span  class="h4 mb-0 app-brand-text fw-semibold">ระบุรายละเอียดแนวทางการแก้ไข:</span>
