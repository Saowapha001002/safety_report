                      ...
                      <div class="bs-stepper wizard-numbered mt-2">
                          ...
                          <div class="bs-stepper-content">
                                <form id="multiStepsFormMagic" enctype="multipart/form-data" onSubmit="return false">
                                    @csrf
                                      ...
                                      <div id="view-risk" class="content">
                                          ...
                                          <div class="row g-4">
                                              ...
                                              <div class="col-sm-6">
                                                  <div class="form-floating form-floating-outline">
                                                      <input type="text" id="sLocation_view"  name="sLocation_view" class="form-control" placeholder="sLocation_view" />
                                                      <label for="sLocation_view">สถานที่/บริเวณที่พบ</label>
                                                  </div>
                                              </div>
                                              <div class="col-sm-6">
                                                  <div class="form-floating form-floating-outline">
                                  ...
                                  </div> <hr class="container-m-nx mb-5" />
                                </div>
