...
<html
  ...
  <body>
    ...
    <div class="misc-wrapper">
      <h1 class="mb-2 mx-2" style="font-size: 6rem">ดำเนินการแจ้งเรื่องเสร็จสิ้น</h1>
      <h4 class="mb-2">โปรดรอการตรวจสอบในลำดับถัดไป ⚠️</h4>
      <p class="mb-4 mx-2"></p>
      <div class="d-flex justify-content-center mt-5">
        ...
        <div class="d-flex flex-column align-items-center">
          <img
            ...
            width="780" />
          <div>
            <a   class="btn btn-primary text-center my-4"   onclick="window.location.href = '{{ route('magic') }}'" >Back to home</a>
          </div>
        </div>
      </div>
    </div>
