                                ...
                                <div class="my-6 me-6">
                                    <h6 class="h5 mb-1">
                                        <span class="h4 mb-0 app-brand-text fw-semibold">ชื่อ - นามสกุล ผู้รายงาน : </span>
                                         {{ $Safety->report_empid }}     {{ $Safety->report_name }}</h6> 
                                </div>       
                                <div class="my-6">
                                    <table>
                                        <tbody>
                                        ...
                                        <div class="d-flex rounded position-relative pe-1">
                                            <div class="">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <span
                                                            class="h4 text-capitalize mb-3 text-nowrap">ระดับความรุนเเรง
                                                            Rank</span>
                                                    ...
                                                    <div class="card-body row">
                                                        <div class="col-md-8">
                                                            ...
                                                            <div id="file-container">
                                                                <div
                                                                    class="file-row mb-2 d-flex gap-2 align-items-center">
                                                        ...
                                                        <div class="col-md-4">
                                                            <button type="button" id="add-file-approve"  class="btn btn-secondary mb-3">เพิ่มไฟล์</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" id="msCheck2" name="msCheck" value="0" />
                                                    <h5 class="form-check-label" for="msCheck">รอการแก้ไข ระบุกำหนดเสร็จ </h5>
                                                    <div class="col-12 form-floating form-floating-outline">
                                                        <input type="date" id="sDateEdit" class="form-control sDateEdit" placeholder="sDateEdit"  name="sDateEdit" />
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="mb-3">
                                                                <label for="note"
                                                                    class="form-label fw-medium">ระบุรายละเอียดแนวทางการแก้ไข:</label>
